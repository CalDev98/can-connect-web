            ...
            <div className="mb-4">
              <div className="relative">
                <textarea
                  ...
                  className="w-full px-4 py-4 bg-white border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-green-500 resize-none min-h-[200px] shadow-lg"
                  rows={6}
                  maxLength={500}
                />
