                ...
                <div className="container mx-auto px-4">
                    <div className="flex items-center justify-around py-2">
                        ...
                        >
                            ...
                            <span className={`${activeTab === "home" ? "text-green-800" : "text-gray-600"} text-xs font-medium`}>{t("home")}</span>
                        </Link>
                        <Link
                            href="/translate"
                        ...
                        >
                            ...
                            <span className={`${activeTab === "translate" ? "text-green-800" : "text-gray-600"} text-xs font-medium`}>{t("nav.translation")}</span>
                        </Link>
                        <Link
                            href="/emergency"
                        ...
                        >
                            ...
                            <span className={`${activeTab === "emergency" ? "text-green-800" : "text-gray-600"} text-xs font-medium`}>{t("nav.emergency")}</span>
                        </Link>
                    </div>
                </div>
            </nav>
