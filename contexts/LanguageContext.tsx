...
const translations: Record<Language, Record<string, string>> = {
  fr: {
    ...
    "home.aiAssistant.desc": "Votre guide personnel au Maroc",
    ...
    "premium.premium.price": "{price}MAD",
  ...
  en: {
    ...
    "home.aiAssistant.desc": "Your personal guide in Morocco",
    ...
    "premium.button": "Upgrade to Premium - {price}MAD",
  ...
  es: {
    ...
    "home.aiAssistant.desc": "Tu guía personal en Marruecos",
    ...
    "premium.button": "Actualizar a Premium - {price}MAD",
  ...
  pt: {
    ...
    "home.aiAssistant.desc": "Seu guia pessoal no Marrocos",
    ...
    "premium.button": "Atualizar para Premium - {price}MAD",
  ...
  ar: {
    ...
    "home.aiAssistant.desc": "دليلك الشخصي في المغرب",
    ...
    "premium.button": "الترقية إلى المميز - {price}MAD",
